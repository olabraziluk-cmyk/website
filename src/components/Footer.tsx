      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div>
            ...
            <p className="text-white/70 text-sm">{businessInfo.tagline}</p>
          </div>
            ...
            <ul className="space-y-2">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-white/70 hover:text-white transition-colors duration-200 cursor-pointer text-sm"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <p className="flex items-start gap-2 text-white/70 text-sm mb-4">
